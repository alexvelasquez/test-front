      ...
      <div>
        ...
        <form @submit.prevent="login">
          <div class="mb-6">
            ...
            />
            <div id="error-username" class="text-red-500 text-xs">{{ errors.username }}</div>
          </div>
          <div class="mb-6">
            ...
            <div class="relative flex items-center mt-2">
              ...
              >
                <v-icon v-if="!showPassword" name="fa-eye" id="show-password"/>
                <v-icon v-else name="fa-eye-slash" id="hide-password"/>
              </button>
            </div>

            <div id="error-password" class="text-red-500 text-xs">{{ errors.password }}</div>
          </div>
          <div>
            <input
              id="remember"
            ...
            />
            <label class="text-sm remember" for="remember">Remember</label>
          </div>
          <button
            type="submit"
            :disabled="!meta.valid"
            class="submit w-full bg-gradient-to-r bg-cyan-600 text-white py-2 rounded-lg mx-auto block mt-4 mb-6"
          >
...
const { login, errors, meta, errorMessage, defineInputBinds } = useAuth();
